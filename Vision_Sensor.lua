...
arduinoData.bottom_servo = angle_to_radiants(rxData[4])
-- Left fan
arduinoData.top_fan_state = rxData[5]
arduinoData.top_fan_thrust = rxData[6]
arduinoData.top_servo = angle_to_radiants(rxData[7])
-- Lift Fan Update
set_lift(lift_fan_handle, arduinoData.lift_fan_state, contact_patch_handle)
-- Right Fan Update
set_thrust(bottom_fan_handle, arduinoData.bottom_fan_state, arduinoData.bottom_fan_thrust/100)
